...
const createOrder = asyncHandler(async (req, res) => {
  ...
  if (orderItems && orderItems.length === 0) {
    ...
    //save () related to save data of Mongo DB BZH
...
const getOrders = async (req, res) => {
  //Order.find({}) is related to query all document in Order collection  in mongo DB BZH
...
//server search about order find it & update it in mongo and send it in res to cleint BZH
